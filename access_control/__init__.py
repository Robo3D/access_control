...
class Access_controlPlugin(octoprint.plugin.SettingsPlugin,
	...
	def get_assets(self):
		...
		# core UI here.
		return dict(
			js=["js/access_control.js"],
			css=["css/access_control.css"],
			less=["less/access_control.less"]
		)
	...
	def get_update_information(self):
		...
		return dict(
			access_control=dict(
				displayName="Access_control Plugin",
				...
				# update method: pip
				pip="https://github.com/victorevector/access_control/archive/{target_version}.zip"
			)
		)
